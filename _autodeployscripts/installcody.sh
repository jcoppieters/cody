...
mysql -e "INSERT INTO cody.websites(name, dbuser, dbpassword, dbhost, datapath, db) VALUES ('$SITENAME', '$SITENAME', '$PASSWORD', 'localhost', '/usr/local/src/cody/jcms/$SITENAME/data', '$DBNAME');";
